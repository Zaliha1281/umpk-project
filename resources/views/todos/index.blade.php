                            ...
                            @foreach ($todos as $todo)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endcan
                                        @can('delete',$todo)
                                            <a onclick="return confirm('Are you sure')" class="btn btn-danger" href="/todos/{{$todo->id}}">Delete</a>
                                        @endcan
                                        <hr>
                                        @can('delete',$todo)
                                            <a onclick="return confirm('Are you sure you want to force delete')" class="btn btn-danger" href="/todos/{{$todo->id}}/force-delete">FORCE Delete</a>
                                        @endcan
                                    </td>
                                </tr>
                            @endforeach
